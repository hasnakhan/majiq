...
upexon_scores_plot <- as.data.frame(cbind(upexon_scores$position, upexon_scores$median, upexon_scores_c$median_c))
colnames(upexon_scores_plot) <- c("position", "alt_med", "cons_med")
upexon_scores_plot <-  upexon_scores_plot %>% pivot_longer(c(alt_med, cons_med), names_to = "Type_median", values_to = "median")
ggplot(upexon_scores_plot, aes(x = position, y = median, colour = Type_median))+
  geom_line()+
  lims(y = c(0, 0.1))
...
downexon_scores_c = list.files(path = "phastCons/Arabidopsis/constitutive/upstream_exon/", pattern = "_phylop.wig", full.names = T)
downexon_scores_c <- do.call(cbind, lapply(downexon_scores_c, read_delim, delim = "\n"))
...
downexon_scores_plot <- as.data.frame(cbind(downexon_scores$position, downexon_scores$median, downexon_scores_c$median_c))
colnames(downexon_scores_plot) <- c("position", "alt_med", "cons_med")
downexon_scores_plot <-  downexon_scores_plot %>% pivot_longer(c(alt_med, cons_med), names_to = "Type_median", values_to = "median")
ggplot(downexon_scores_plot, aes(x = position, y = median, colour = Type_median))+
  geom_line()+
  lims(y = c(0, 0.1))
```
...
intron5_scores_c = list.files(path = "phastCons/Arabidopsis/constitutive/upstream_exon/", pattern = "_phylop.wig", full.names = T)
...
median_c <- rollapply(median_c, width = 3, by = 1, FUN = median, partial = T)
intron5_scores_c <- cbind(intron5_scores_c, median_c)

intron5_scores_plot <- as.data.frame(cbind(intron5_scores$position, intron5_scores$median, intron5_scores_c$median_c))
colnames(intron5_scores_plot) <- c("position", "alt_med", "cons_med")
intron5_scores_plot <-  intron5_scores_plot %>% pivot_longer(c(alt_med, cons_med), names_to = "Type_median", values_to = "median")
ggplot(intron5_scores_plot, aes(x = position, y = median, colour = Type_median))+
  geom_line()+
  lims(y = c(0, 0.1))
```
...
intron3_scores_c = list.files(path = "phastCons/Arabidopsis/constitutive/upstream_exon/", pattern = "_phylop.wig", full.names = T)
...
median_c <- rollapply(median_c, width = 3, by = 1, FUN = median, partial = T)
intron3_scores_c <- cbind(intron3_scores_c, median_c)

intron3_scores_plot <- as.data.frame(cbind(intron3_scores$position, intron3_scores$median, intron3_scores_c$median_c))
colnames(intron3_scores_plot) <- c("position", "alt_med", "cons_med")
intron3_scores_plot <-  intron3_scores_plot %>% pivot_longer(c(alt_med, cons_med), names_to = "Type_median", values_to = "median")
ggplot(intron3_scores_plot, aes(x = position, y = median, colour = Type_median))+
  geom_line()+
  lims(y = c(0, 0.1))
```


don't really think this is interesting, alt and cons look virtually identical in the exons, in the introns the cons ones are more conserved, which is weird?