...
```{r}
ggplot(bp, aes(x = log10(num_terms), y = group, fill = group, colour= group))+
  geom_density_ridges(scale = .95, alpha = 0.6)+
  scale_fill_manual(values = c("turquoise", "limegreen", "orchid"))+
  scale_colour_manual(values = c("turquoise", "limegreen", "orchid"))+
  theme_minimal()+
  theme(legend.position = "none",
        axis.title.x = element_text(colour = "grey10"))+
  labs(x = "log10 (Number of GO biological processes per gene)",
       y = "")+
  scale_y_discrete(labels = c("DE" = "DE genes\nn = 8989", "dAS" ="dAS genes\nn = 406", "unreg" = "Unregulated genes\nn = 18 247"))+
geom_signif(y_position = c(2.02, 2.2, 2.4), xmin = c(0.9, 1.9, 0.9), xmax = c(2.8, 3.8, 3.8), annotations = c("NS", "***", "***"), colour = "grey10", tip_length = 0.01, vjust = 0)
```
...
```{r}
ggplot(cc, aes(x = log10(num_terms), y = group, fill = group, colour= group))+
  geom_density_ridges(scale = .95, alpha = 0.6)+
  scale_fill_manual(values = c("turquoise", "limegreen", "orchid"))+
  scale_colour_manual(values = c("turquoise", "limegreen", "orchid"))+
  theme_minimal()+
  theme(legend.position = "none",
        axis.title.x = element_text(colour = "grey10"))+
  labs(x = "log10 (Number of GO cellular components per gene)",
       y = "")+
  scale_y_discrete(labels = c("DE" = "DE genes\nn = 8989", "dAS" ="dAS genes\nn = 406", "unreg" = "Unregulated genes\nn = 18 247"))+
...
```{r}
ggplot(mf, aes(x = log10(num_terms), y = group, fill = group, colour= group))+
  geom_density_ridges(scale = .95, alpha = 0.6)+
  scale_fill_manual(values = c("turquoise", "limegreen", "orchid"))+
  scale_colour_manual(values = c("turquoise", "limegreen", "orchid"))+
  theme_minimal()+
  theme(legend.position = "none",
        axis.title.x = element_text(colour = "grey10"))+
  labs(x = "log10 (Number of GO molecular functions per gene)",
       y = "")+
  scale_y_discrete(labels = c("DE" = "DE genes\nn = 8989", "dAS" ="dAS genes\nn = 406", "unreg" = "Unregulated genes\nn = 18 247"))+
