...
vast_k40dl40d <- read_delim("../../vasttools/all_data/dPSI25_no_merging_all_reps/K40d-L40d_168events/K40d-L40d_compare_ouput_complete.tab", col_names = T, delim = "\t") %>% 
  select(GeneID) %>% 
  mutate(prog = c("vast-tools"), comp = c("K40dL20d"))
...
```{r}
#this may objectively be some of the ugliest code I've eve written... find a way to clean this up!
...
ggplot(to_plot, aes(x = comp, y = count, fill = prog))+
